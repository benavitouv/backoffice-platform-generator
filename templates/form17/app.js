...
form.addEventListener('submit', async (event) => {
  ...
  if (!file) {
    setStatus('error', 'Please attach a medical referral before submitting.');
    return;
  }

  submitBtn.disabled = true;
  form.classList.add('is-loading');
  setStatus('info', 'Uploading medical referral and submitting Form 17 request...');
  ...
  try {
    ...
    setStatus(
      'success',
      'Request submitted successfully! If everything is correct, you will receive Form 17.'
    );
    form.reset();
    setFile(null);
    showSuccessModal();
